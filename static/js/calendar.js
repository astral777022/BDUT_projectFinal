...
Cal.prototype.showMonth = function(y, m) 
{
	...
	do 
    {
		...
		var eventsForDay = this.events.filter(event => 
        {
			...
			return eventDate.getFullYear() === y && eventDate.getMonth() === m && eventDate.getDate() === i;
		});
...
Cal.prototype.showDayEvents = function(year, month, day) 
{
    ...
    {
		eventContainer.innerHTML = `<p>Не заплановано ніяких подій</p>`;
	}
	...
	Cal.prototype.showDayEvents = function(year, month, day) 
    {
		...
		if (eventsOnDay.length > 0) 
        {
			eventsOnDay.forEach(event => 
            {
				...
				`;
				eventContainer.innerHTML += eventHtml;
>>>>>>> 2b5e4e5c5d010cae8df99b87d3e291eda5c4b264
			});
		} 
        else 
        {
